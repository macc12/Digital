                                                    ...
                                                    <div>
                                                        <form action="UsuarioServlet" method="POST">
                                                            <div class="form-group" size="5">
                                                                <input type="text" size="5" class="form-control" id="uid" name="usuario"  placeholder="usuario" >
                                                            </div>
                                                            <div class="form-group" size="5">
                                                                <input type="text" class="form-control" id="uid" name="password"  placeholder="password" size="5">
                                                            </div>                                                                
